...
game9gdialog.innerHTML='<header><h2 id="game9gtitle">蚂蚁HTML5社区手机游戏</h2></header><section id="game9gcontent"></section><footer><a href="javascript:void(0)" id="game9gleftbtn">取消</a><a href="javascript:void(0)" id="game9grightbtn">确定</a></footer>';
...
var domain = domains[parseInt(Math.random() * domains.length)];
    if(window.shareData){
		window.shareData.timeLineLink = "http://www.zzfriend.com/demo/youxi/m/djz/index.html";
